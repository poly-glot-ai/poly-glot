  ...
  const PLANS = [
    {
      ...
      features: [
        ...
        { text: 'CLI tool (4 languages)',            check: true  },
        { text: '25 GitHub App PR reviews / month',  check: true  },
        { text: 'WHY comments',                      check: false },
        { text: 'MCP server access',                 check: false },
        { text: 'VS Code extension (full)',          check: false },
      ],
    },
    {
      id:        'pro',
      ...
      features: [
        ...
        { text: 'Web UI + CLI + VS Code (full)',      check: true },
        { text: 'WHY + Both comment modes',          check: true },
        { text: 'GitHub App — unlimited PR reviews', check: true },
        { text: 'MCP server — 200 calls / month',   check: true },
    ...
    },
    {
      ...
      monthly:   29,
      yearly:    249,
      desc:      'For engineering teams. Up to 5 seats, shared token.',
      cta:       'Get Team →',
      ...
      features: [
        ...
        { text: 'Up to 5 seats',                     check: true },
        { text: 'MCP server — 1,000 calls / month',  check: true },
        ...
        { text: 'Custom comment style templates',    check: true, soon: true },
