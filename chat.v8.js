...
[GitHub App Source →](https://github.com/hmoses/poly-glot-github-app)`,
  ...
  async function askAI(question, history) {
    ...
    try {
      if (provider === 'openai') {
        ...
        const res = await fetch('https://poly-glot.ai/api/ai/proxy', {
          method:  'POST',
  ...
  // Runs AFTER RULES and SUGGESTIONS are declared.
  // When loaded on /prompt/, swap KNOWLEDGE, RULES, and SUGGESTIONS for
  // Prompt Studio-specific content.
