 ...
 * • EARLYBIRD3 promo code tracking — tags users for 50% off first 3 months
...
(function () {
  ...
  const PromoTracker = {
    ...
    save(email, source, extra) {
      ...
      const record = {
        ...
        promo_perk: '50% off first 3 months',
    ...
    exportCSV() {
      ...
      const rows = users.map((u, i) => [
        ...
        '"' + (u.promo_perk || '50% off first 3 months') + '"',
        u.source     || ''
      ]);
      ...
      <div class="pg-banner-inner">
        <div class="pg-banner-left">
          ...
          <span class="pg-banner-msg">
            <strong>🎉 Pro is live — get 50% off your first 3 months.</strong>
        ...
        <div class="pg-wm-header">
          <div class="pg-wm-header-left">
            ...
            <div>
              ...
              <p class="pg-wm-subtitle">Join the waitlist — get 50% off your first 3 months at launch. Use code <strong>EARLYBIRD3</strong> when you sign up.</p>
            </div>
          </div>
    ...
    if (form) {
      form.innerHTML = `
        <div class="pg-wm-already-joined">
          ...
          <p>We have <strong>${escapeHtml(email)}</strong> saved. You'll be the first to know when Poly-Glot Pro launches — and you'll get <strong>50% off your first 3 months</strong>.</p>
  ...
  function handleWaitlistSubmit(e) {
    ...
    claimEmailGlobal(email).then(function (result) {
      ...
      fd.append('promo_perk', isPromo ? '50% off first 3 months' : 'standard');
  ...
  function showAlreadyOnList(email, successEl, errorEl, isPromo) {
    ...
    if (successEl) {
      var promoLine = isPromo
        ? ' You\'ll get <strong>50% off your first 3 months</strong> when Pro launches.'
        : '';
      successEl.innerHTML =
  ...
  function onWaitlistSuccess(data, submitBtn, btnText, btnLoad, successEl, errorEl) {
    ...
    if (successEl) {
      successEl.innerHTML = isPromo
        ? '🎉 Welcome, early bird! You\'re on the list + your <strong>EARLYBIRD3</strong> promo code is saved — enjoy <strong>50% off your first 3 months</strong> when Pro launches. Check your inbox! 🚀'
        : '🎉 You\'re in! We\'ll email <strong>' + escapeHtml(data.email) + '</strong> when Pro launches — and you\'ll get 50% off your first 3 months.';
      successEl.style.display = 'block';
    }
    ...
    inner.innerHTML = `
      <div class="pg-banner-left">
        ...
        <span class="pg-banner-msg">
          ...
          <span class="pg-banner-sub"> You'll get early access + 50% off your first 3 months at launch. Use code EARLYBIRD3 when you sign up.</span>
        </span>
      </div>
      <div class="pg-banner-right">
  ...
  function wireShareButtons() {
    const shareText = encodeURIComponent('🦜 Just joined the @PolyGlotAI Pro waitlist — AI-powered code docs for 12 languages. Get 50% off your first 3 months at launch: https://poly-glot.ai #DevTools #AI');
    const liText    = encodeURIComponent('I just joined the Poly-Glot Pro waitlist — AI-powered code comment generation for 12 languages. Get 50% off your first 3 months at launch. https://poly-glot.ai');
    ...
    section.innerHTML = `
      <div class="pg-wis-content">
        <div class="pg-wis-left">
          ...
          <p class="pg-wis-sub">Unlimited files. Confidence scoring. Team dashboards. Fine-tune export for LLMs.<br>Join the waitlist — get <strong>50% off your first 3 months</strong> at launch. Use code <strong>EARLYBIRD3</strong> when you sign up.</p>
        </div>
        ...
        setTimeout(function () {
          ...
          if (sub) {
            sub.innerHTML =
              ...
              '<strong>50% off your first 3 months</strong> at launch. Use code <strong>EARLYBIRD3</strong>.';
          }
        }, 50);
