  ...
  function updateHeaderForUser(email, plan) {
    ...
    if (billingBtn) {
      billingBtn.addEventListener('click', function (e) {
        e.stopPropagation();
        closeMenu();
        var returnUrl = IS_PROMPT_PAGE ? 'https://poly-glot.ai/prompt' : 'https://poly-glot.ai/dashboard';
        var portalUrl = _token
          ? 'https://poly-glot.ai/api/auth/billing-portal?token=' + encodeURIComponent(_token) + '&return=' + encodeURIComponent(returnUrl)
          : 'https://billing.stripe.com/p/login/bJe3cx7cU1Na4nY8bO14400';
